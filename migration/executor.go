...
func (ms Executor) Exec(db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection) (int, error) {
	return ms.ExecMaxContext(context.Background(), db, dialect, m, dir, 0)
}

// Returns the number of applied migrations.
func (ms Executor) ExecContext(ctx context.Context, db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection) (int, error) {
	return ms.ExecMaxContext(ctx, db, dialect, m, dir, 0)
}

// Returns the number of applied migrations.
func (ms Executor) ExecMax(db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection, max int) (int, error) {
...
func (ms Executor) ExecMaxContext(ctx context.Context, db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection, max int) (int, error) {
...
// Returns the number of applied migrations.
func (ms Executor) ExecVersion(db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection, version int64) (int, error) {
	return ms.ExecVersionContext(context.Background(), db, dialect, m, dir, version)
}

func (ms Executor) ExecVersionContext(ctx context.Context, db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection, version int64) (int, error) {
...
func (Executor) applyMigrations(ctx context.Context, dir MigrationDirection, migrations []*PlannedMigration, dbMap *dialect.DbMap) (int, error) {
	applied := 0
...
// Plan a migration.
func (ms Executor) PlanMigration(db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection, max int) ([]*PlannedMigration, *dialect.DbMap, error) {
	return ms.planMigrationCommon(db, dialect, m, dir, max, -1)
}

// Plan a migration to version.
func (ms Executor) PlanMigrationToVersion(db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection, version int64) ([]*PlannedMigration, *dialect.DbMap, error) {
	return ms.planMigrationCommon(db, dialect, m, dir, 0, version)
}

// A common method to plan a migration.
func (ms Executor) planMigrationCommon(db *sql.DB, dialect string, m MigrationSource, dir MigrationDirection, max int, version int64) ([]*PlannedMigration, *dialect.DbMap, error) {
...
func (ms Executor) GetMigrationRecords(db *sql.DB, dialect string) ([]*MigrationRecord, error) {
	dbMap, err := ms.getMigrationDbMap(db, dialect)
	if err != nil {
		return nil, err
	}
...
func (ms Executor) getMigrationDbMap(db *sql.DB, dialectType string) (*dialect.DbMap, error) {
	d, ok := MigrationDialects[dialectType]
	if !ok {
